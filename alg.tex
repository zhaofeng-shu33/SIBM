...
\end{figure}
 We also plot the result of Theorem 4 in \cite{abbe17sideinfo} using green line. It can be seen that our red line
is strictly over the green line, which illustrates the difference between controlling the error probability of
at least two mislabeling nodes (ours) and that of one mislabeling node (Abbe).
