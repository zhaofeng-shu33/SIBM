...
However, due to the symmetric property of the problem, if we should consider
$$
...
For \eqref{eq:g1}, if we take $u=g/\sqrt{n}$, we can show that both left and
right hand side equals to $-\frac{4}{n} \sum_{i<j, j \not\in S(i)} B_{ij}$.
