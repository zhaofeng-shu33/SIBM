...
\begin{lemma}
	...
	where 
	\begin{align}
	N_w &= \frac{1}{2}\sum_{i=0}^{k-1} (I_i - I_i')^2 \\
	B_w & \sim Binom(\frac{n}{k}I + \frac{1}{2}\sum_{i=0}^{k-1}  (-2 I'_i I_i  + I'^2_i) , q)\\
	A_w & \sim Binom(\frac{n}{k}I - \frac{1}{2}\sum_{i=0}^{k-1}  I^2_i, p)
	\end{align}
