...
\newcommand{\ind}[2]{ \mathbbm{1}_{#1 = #2} }
...
\exp\Big(\beta \sum_{\{i,j\}\in E(G)} \ind{\bar{\sigma}_i}{\bar{\sigma}_j}\notag\\
&-\frac{\alpha\log(n)}{n} \sum_{\{i,j\}\notin E(G)} \ind{\bar{\sigma}_i}{\bar{\sigma}_j}
\Big)
\end{align}
